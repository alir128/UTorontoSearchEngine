...
public class MongoUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        if(user != null) {
            ...
            mongouser = new MongoUser(user.getEmail(),user.getPassword(),user,user.isEnabled(),true,true,true,authorities,user.getFirstName(), user.getFullname(),user.getLastName(),user.getType(),user.getId());
            return mongouser;
        } else {
